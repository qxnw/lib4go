...
func TestRingCounter1(t *testing.T) {
	...
	ut.ExpectSkip(t, counter.counter, int32(2))
	counter.mark(1, int64(2))
	ut.ExpectSkip(t, counter.counter, int32(3))
	counter.mark(1, int64(3))
	ut.ExpectSkip(t, counter.counter, int32(4))
	counter.mark(1, int64(4))
	ut.ExpectSkip(t, counter.counter, int32(5))
	counter.mark(1, int64(5))
	ut.ExpectSkip(t, counter.counter, int32(6))
	counter.mark(1, int64(6))
	ut.ExpectSkip(t, counter.counter, int32(6))

	counter.mark(12, int64(12))
	ut.ExpectSkip(t, counter.counter, int32(12))

	counter.mark(13, int64(100))
	ut.ExpectSkip(t, counter.counter, int32(13))
